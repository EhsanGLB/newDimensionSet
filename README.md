# newDimensionSet
This is a library for new dimensionSet written based on foam-extend-4.1.


## Installation
It is working on foam-extend-4.1.
```bash
git clone https://github.com/EhsanGLB/newDimensionSet.git
cd newDimensionSet/newDimensionSet
wmake libso
```


## Activation
Add directory of lnInclude (the compiled headers file) and libnewDimensionSet to solver/Make/option
